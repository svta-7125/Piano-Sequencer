...
flag1 = 1
if not os.path.isdir(os.environ['USERPROFILE']+"/Piano_Sequencer"): os.makedirs(os.environ['USERPROFILE']+"/Piano_Sequencer")
#if not os.path.isdir(os.environ['USERPROFILE']+"/Piano_Sequencer/System Files") : os.makedirs(os.environ['USERPROFILE']+"/Piano_Sequencer/System Files")
os.system('color B')
url = 'https://api.github.com/repos/svta-7125/Piano-Sequencer/releases'
def scroller(x,y):
    print(x, end='')
    a = '...................................'
    for char in a:
...
1)Enter notes and play song           2)Save a song            3)Edit an existing song

4)Run a song                          5)Delete a song          6)Open Settings

7)Show options                        8)Help                   9)Exit''')
while True:
    bpm = 0
    print('''
...
7)Show options                        8)Help      9)Exit''')
        ...
        print('''
Type your notes in order and let the song play!
